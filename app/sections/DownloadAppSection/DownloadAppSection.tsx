...
export default function DownloadAppSection  () {
  return (
    <section className="w-full bg-[#fdfdfd]  pt-[99px] max-[1000px]:py-[60px] max-[767px]:py-10 px-[160px] max-[1500px]:px-20 max-[1100px]:px-[50px] max-[767px]:px-[25px] relative">
...
<img className="absolute bottom-[-100px] left-[-100px] w-[318px] h-[277px] object-contain max-[1000px]:w-[200px] max-[1000px]:h-[220px] max-[500px]:w-[130px] max-[500px]:h-[150px]  max-[500px]:left-[-25px] max-[1000px]:left-[-50px]"  alt="Background pattern"  src="/img-6.png" />
      ...
      <div className="w-full max-[1500px]:max-w-[1440px] h-[383px] max-[1020px]:h-[850px] max-[767px]:h-[750px] max-[500px]:h-[650px] flex flex-col lg:flex-row items-center justify-between bg-[#bc430d]/57 rounded-[30px] p-8 max-[500px]:p-5">
        <div className="w-full max-w-[683px] max-[1500px]:max-w-[583px] max-[1100px]:max-w-[450px] max-[1020px]:max-w-[100%] text-center lg:text-left mb-10 lg:mb-0">
          <h2 className="font-poppins font-bold text-white text-[56px] max-[1500px]:text-[48px] max-[767px]:text-[36px] max-[767px]:leading-[38px] leading-[46px] mb-6">
            Download the food you love
          </h2>
          <p className="w-[400px] max-[1500px]:w-[344px] max-[1020px]:w-[100%] font-poppins font-regular text-white text-lg max-[1500px]:text-base max-[767px]:text-sm leading-[24px]  mb-8">
