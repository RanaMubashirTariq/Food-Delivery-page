...
const RestaurantCard: React.FC<RestaurantCardProps> = ({
  ...
  <div className="bg-[#bc430d]/10  border border-[1px] border-[#bc430d]/20 rounded-[50px]  overflow-hidden transform transition-transform duration-300 hover:scale-105">
    ...
    <div className="p-4 flex items-start justify-between">
      ...
      <p className="font-poppins font-medium text-[#c08266] text-lg max-[1500px]:base max-[1000px]:text-sm max-[1000px]:leading-5  leading-[27px] tracking-0 mb-3">
        {location}
      </p>
        </div>
      <div className="flex items-center space-x-1">
        <img className="w-4 h-4" alt="Star icon" src="/star.png" />
        <span className="font-poppins text-[#272727] text-lg max-[1500px]:base  max-[1000px]:text-sm  max-[1000px]:leading-5  leading-[27px] font-semibold">
          {rating}
        </span>
        <span className="font-poppins text-[#999999] text-lg max-[1500px]:base max-[1000px]:text-sm max-[1000px]:leading-5 leading-[27px] font-semibold">
          {user}
        </span>
      </div>
    </div>
...
export default function ExploreAllRestaurantsSection  () {
  ...
  return (
    <section className="relative w-full bg-[#fdfdfd] pt-20 max-[1000px]:pt-10 pb-5 px-[120px] max-[1500px]:px-20 max-[1100px]:px-[50px] max-[767px]:px-[25px]">
      ...
      <div className=" mx-auto  w-full max-[1500px]:max-w-[1440px]">
        <div className="flex items-center justify-between mb-10 md:mb-16 sm:mb-15 max-[767px]:flex-col max-[767px]:gap-5 max-[500px]:items-start">
          <h2 className="font-poppins font-bold text-[#bc430d] text-[56px] max-[1500px]:text-[48px] max-[767px]:text-[36px] max-[767px]:leading[50px] max-[800px]:leading-[54px] leading-[27px]">
            Explore All Restaurants
          </h2>
          <Button className="cursor-pointer bg-white text-[#bc430d] font-bold rounded-full h-[40px] px-6  border border-[1px] border-[#bc430d] flex items-center font-poppins text-xl font-semibold">
            <img className="w-5 h-5 max-[1500px]:w-4 max-[1500px]:h-4 inline-flex mr-[11px]" alt="Filter icon" src="/filter-icon.png" />
            Filter
          </Button>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-[1500px]:gap-6">
