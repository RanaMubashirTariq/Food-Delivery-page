  ...
  return (
    <section className="relative w-full h-[665px] max-[1000px]:h-[900px] max-[767px]:h-[650px] bg-[#bc430d]/80 py-10  overflow-hidden">
      ...
      <img
        ...
        src="/img-1.png"
      />
        <div className="w-full flex flex-col  text-center text-left mb-10 pl-[120px] max-[1500px]:pl-[80px] max-[1100px]:pl-[50px] max-[767px]:px-[25px] pt-[94px] max-[1000px]:pt-[20px] gap-[42px] max-[1100px]:gap-[30px] max-[767px]:gap-[20px] relative z-20">
          <h2 className=" font-poppins font-bold max-[1100px]:w-[450px] max-[1000px]:w-[100%] text-white text-[56px] max-[1500px]:text-[48px] max-[767px]:text-[36px] leading-[100%] mb-6 ">
          ...
          <div className="flex  flex-row items-center  p-4  bg-[#bc430d]/50 w-[522px] max-[1100px]:w-[450px] max-[767px]:w-[100%] h-[82px] max-[767px]:h-[60px] max-[767px]:rounded-[30px] rounded-[40px] border border-[1px] border-white">
            ...
            />
            <Button className="cursor-pointer bg-transparent border-none outline-none  rounded-full  h-[52px] max-[767px]:h-10 max-[767px]:w-[120px] px-8    flex items-center justify-center  ">
      ...
      <div className="absolute top-[0px] max-[1000px]:top-[200px] right-[200px] max-[1500px]:right-[106px]  max-[1300px]:right-[50px] max-[767px]:right-[35px] w-full  flex  justify-end " >
          <img
